...
<template>
   <section class="mt-12 w-4/6">
      ...
      <article>
         <h2
            class="text-xl font-bold after:block after:pb-2 after:border-b-2 after:border-dotted after:border-secondary after:w-4/6 after:pointer-events-none"
         >
            Latest created entries
         </h2>
      ...
      <article class="mt-20">
         <h2
            class="text-xl font-bold after:block after:pb-2 after:border-b-2 after:border-dotted after:border-secondary after:w-4/6"
         >
            30 entries created last year
         </h2>
      </article>
      <!-- Latest mod team creation -->
      <article class="mt-20">
         <h2
            class="text-xl font-bold after:block after:pb-2 after:border-b-2 after:border-dotted after:border-secondary after:w-4/6 after:pointer-events-none"
         >
            Latest mod team contribution
         </h2>
      </article>
   </section>
</template>
